...
if draw_char < text_length[page]
   ...
   if draw_char == text_length[page]
	  ...
	  //se a escrita não está completa
	  else
	       {
			...
			//código para quando estiver utilizando sprite grande, não quebrar a geração de texto
			/*if speaker_sprite[page] == wanyBIGSpeakSprite{
				 draw_char = 0;
				 if accept_key and draw_char < text_length[page] and text_pause_timer > 0{
					draw_char = text_length[page];
				 }
			}
		   */
  ...
  if speaker_sprite[page] != noone 
  {
	...
	//pra fazer a textbox com sprite grande o código precisa ser esse:
		//draw_sprite_ext(txtb_spr[page], txtb_img, textbox_x + portrait_x_offset[page], textbox_y + 118, sprite_width/txtb_spr_w, sprite_height/txtb_spr_h, 0, c_white, 1);
		//draw_sprite_ext(sprite_index, image_index, _speaker_x - 4, textbox_y - 70, speaker_side[page], 1, 0, c_white, 1);
